    ...
    function homeDepot($product){
        ...
        if($empezar_de_cero === false){
            ...
            for($x=0;$x<$total_productos_recividos;$x++){
                ...
                if(strtoupper($nombre_marca) == 'SAMSUNG' || strtoupper($nombre_marca) == 'LG ELECTRONICS'){
                    ...
                    if($check_repetido){
                        ...
                        if(!$check_existe){
                            $check_producto_nuevo = true;
                            @$product->skus[$x]->estado = 'pendiente';
                            @$product->tiendas = array();
                            $product->skus[$x]->tiendas[] = 'homedepot';
                            $array_producto_nuevo[] = $product->skus[$x];
                        }                  
                    }
                }
            }
